...
export const ProjectList1: CardItem[] = [
  {
    ...
    features: [
      "Custom Interactive Animations - <strong class='text-white font-bold'>10+ Framer Motion sequences</strong> including <strong class='text-white font-bold'>image slice animations</strong>, <strong class='text-white font-bold'>gradient text effects</strong>, <strong class='text-white font-bold'>smooth scroll triggers</strong>, <strong class='text-white font-bold'>custom cursor interactions</strong>, and <strong class='text-white font-bold'>typing animations</strong> for fully engaging visual experience.",
